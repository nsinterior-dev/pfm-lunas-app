...
|----------|---------|-----------|
| Showing debt totals | Card with Red (`#E24B4A`) | Immediate danger/attention signal |
| Savings/Growth | Card with Teal (`#1D9E75`) | Brand alignment + positive reinforcement |
| AI analysis | Accent Purple (`#7F77DD`) | Distinguish AI insights from raw data |
